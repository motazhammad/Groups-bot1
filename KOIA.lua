------------------------------------------------
-- This Source Was Developed By (KADI) @BBlI9.--
--   This Is The Source Channel @BBlI9 .   --
--                - 𝗦𝗼𝘂𝗿𝗰𝗲 𝗞𝗔𝗗𝗜-                 --
--        -- https://t.me/BBlI9 --         --
------------------------------------------------ 
...
return {
Lock     = '[- SOURCE KADI .](https://t.me/G0BBBI)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[- SOURCE KADI .](https://t.me/G0BBBI)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[- SOURCE KADI .](https://t.me/G0BBBI)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[- SOURCE KADI .](https://t.me/G0BBBI)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[- SOURCE KADI .](https://t.me/G0BBBI)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[- SOURCE KADI .](https://t.me/G0BBBI)\n*— — — — — — — — —\n᥀︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheKOIA.."KOIA:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheKOIA.."KOIA:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(TheKOIA..'KOIA:GetTexting:DevTheKOIA'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر ⌔' then 
Redis:del(TheKOIA..'KOIA:GetTexting:DevTheKOIA'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم الغاء حفظ كليشة المطور')
end
Redis:set(TheKOIA..'KOIA:Texting:DevTheKOIA',text)
Redis:del(TheKOIA..'KOIA:GetTexting:DevTheKOIA'..msg_chat_id..':'..msg.sender.user_id)
...
{
{text = '『 𝗦𝗢𝗨𝗥𝗖𝗘 𝗞𝗔𝗗𝗜』', url = 't.me/G0BBBI'},
},
}
}
if not msg.ControllerBot then
...
local MsgId = msg.id/2097152/0.5
local MSGID = string.gsub(MsgId,'.0','')
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/lDIDIl/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..MsgId.."&parse_mode=markdown") 
end
--------------------------------------------------------------------------------------------------------------
...
data = {
{
{text = '- قناة السورس', url = 't.me/G0BBBI'}, 
},
}
}
...
keyboard.inline_keyboard = {
{
{text = 'قناة السورس ', url = "https://t.me/G0BBBI"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = '༄ Developer', url = "https://t.me/BBlI9"},{text = ' ༄ Exp Source .', url = "https://t.me/G0BBBI"}
},
{
{text = ' ༄ Tws 𝗞𝗔𝗗𝗜 〠', url = "https://t.me/IFlFIGBOT"}
},
{
{text = ' ༄ Source Channel', url = "https://t.me/G0BBBI"}
},
}
local msgg = msg_id/2097152/0.5
...
if text == (Redis:get(TheKOIA.."KOIA:Name:Bot") or "كادي") then
local NamesBot = (Redis:get(TheKOIA.."KOIA:Name:Bot") or "كادي")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(TheKOIA.."KOIA:Name:Bot") or "كادي")..
